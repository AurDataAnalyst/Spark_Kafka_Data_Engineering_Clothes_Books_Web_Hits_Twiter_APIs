...
export CLASSPATH=/home/auredata/spark-data-engg/includes/*

/usr/local/kafka/bin/connect-standalone.sh \
/usr/local/kafka/config/connect-standalone.properties \
/home/auredata/spark-data-engg/connect-us-sales-data.properties 
...
connection.url=jdbc:mysql://192.168.0.12:3306/us_sales?user=cloudera&password=cloudera
